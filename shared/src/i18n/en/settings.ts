...
const settings: TranslationStrings = {
  ...
  'settings.ntfyUrl.topicPlaceholder': 'my-TREK India-alerts',
  ...
  'settings.about.supporters.title': 'Travel companions for TREK India',
  'settings.about.supporters.subtitle':
    "While you're planning your next route, these folks are helping plan TREK India's future. Their monthly contribution goes straight into development and real hours spent — so TREK India stays Open Source.",
  ...
  'settings.about.description':
    'TREK India is a self-hosted travel planner that helps you organize your trips from the first idea to the last memory. Day planning, budget, packing lists, photos and much more — all in one place, on your own server.',
  ...
  'settings.airtrail.writeBackHint':
    'Off by default: AirTrail is the source of truth and TREK India only reads from it. Turn on to push edits made in TREK India back to AirTrail.',
