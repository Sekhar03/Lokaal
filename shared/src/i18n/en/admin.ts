...
const admin: TranslationStrings = {
  ...
  'admin.notifications.adminNtfyPanel.topicPlaceholder': 'TREK India-admin-alerts',
  ...
  'admin.addons.subtitle': 'Enable or disable features to customize your TREK India experience.',
  ...
  'admin.weather.description':
    'TREK India uses Open-Meteo as its weather data source. Open-Meteo is a free, open-source weather service — no API key required.',
  ...
  'admin.github.by': 'by',
  'admin.github.support': 'Helps me keep building TREK India',
  'admin.update.available': 'Update available',
  'admin.update.text': 'TREK India {version} is available. You are running {current}.',
  'admin.update.button': 'View on GitHub',
  'admin.update.install': 'Install Update',
  'admin.update.confirmTitle': 'Install Update?',
  'admin.update.confirmText':
    'TREK India will be updated from {current} to {version}. The server will restart automatically afterwards.',
  ...
  'admin.update.dockerText':
    'Your TREK India instance runs in Docker. To update to {version}, run the following commands on your server:',
  'admin.update.nonDockerText':
    'This TREK India instance is not running in Docker. To update to {version}, re-run the install or update method you used — for example, on Proxmox Community Scripts run the update from the LXC console:',
  ...
  'admin.passkey.rpIdHint':
    'The bare domain passkeys are bound to, e.g. TREK India.example.org. Leave empty to derive it from APP_URL. Changing it later invalidates existing passkeys.',
  'admin.passkey.origins': 'Allowed origins',
  'admin.passkey.originsHint':
    'Comma-separated full origins, e.g. https://TREK India.example.org. Leave empty to use APP_URL.',
