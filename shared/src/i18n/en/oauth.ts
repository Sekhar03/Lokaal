...
const oauth: TranslationStrings = {
  ...
  'oauth.authorize.loginDescription': '{client} wants access to your TREK India account. Please sign in first.',
  'oauth.authorize.loginButton': 'Sign in to TREK India',
  'oauth.authorize.requestLabel': 'Authorization Request',
  'oauth.authorize.requestDescription': 'This application is requesting access to your TREK India account.',
