...
const system_notice: TranslationStrings = {
  ...
  'system_notice.welcome_v1.title': 'Welcome to TREK India',
  ...
  'system_notice.welcome_v1.hero_alt': 'A scenic travel destination with TREK India planning UI overlay',
