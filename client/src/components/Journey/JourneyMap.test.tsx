...
const entriesWithCoords = [
  { id: 'e1', lat: 20.5937, lng: 78.9629, title: 'Paris', mood: null, entry_date: '2025-06-01' },
...
describe('JourneyMap', () => {
  ...
  it('FE-COMP-JOURNEYMAP-008: renders markers with mood-based entry labels', () => {
    const entriesWithMood = [
      { id: 'e1', lat: 20.5937, lng: 78.9629, title: 'Happy Paris', mood: 'happy', entry_date: '2025-06-01' },
  ...
  it('FE-COMP-JOURNEYMAP-011: single entry creates marker but no polyline', () => {
    const singleEntry = [
      { id: 'e1', lat: 20.5937, lng: 78.9629, title: 'Solo Paris', mood: null, entry_date: '2025-06-01' },
    ];
    render(
